...
function Gift() {
  return (
    <div className="overflow-hidden">
      ...
      {/* الصور - صغيرة في sm, عادية في md وفوق */}
      <div className='flex justify-center mt-40 scale-75 md:scale-100 transition-all duration-300'>
        <Image src={"/66.png"} width={70} height={70} alt="pic1"
          className='h-[300px] w-[220px] z-30 object-contain -rotate-12 relative left-64 bottom-11'
        />
        <Image src={"/55.png"} width={70} height={70} alt="pic2"
          className='z-40 h-[300px] w-[220px] -rotate-6 relative left-32 bottom-20'
        />
        <Image src={"/2.png"} width={70} height={70} alt="pic3"
          className='z-50 h-[300px] w-[220px] relative bottom-28'
        />
        <Image src={"/3.png"} width={70} height={70} alt="pic4"
          className='z-40 h-[300px] w-[220px] rotate-6 relative -left-32 bottom-20'
        />
        <Image src={"/4.png"} width={70} height={70} alt="pic5"
          className='z-30 h-[300px] w-[220px] rotate-12 relative -left-64 bottom-11'
        />
      </div>
