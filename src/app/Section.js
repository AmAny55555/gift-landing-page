...
function Card(props) {
  return (
    <div
      ...
      className="rounded-xl bg-white p-6 w-[250px] h-[407px] mx-auto"
    >
      <div className="flex justify-center items-center w-full h-[335px]">
        <Image src={props.src} width={201} height={335} alt="img" />
      </div>
      <p className="text-center mt-2 text-xs flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap text-black">
...
<p className="font-poppins font-medium  whitespace-nowrap text-base sm:text-lg md:text-2xl mb-10">
  Make Gifting as
  <span className="text-[#FF2A2A] text-sm sm:text-xs md:text-lg font-press align-baseline"> Fun as Building</span>
</p>


<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-4 lg:gap-20 justify-center items-center lg:p-10  mt-7">
